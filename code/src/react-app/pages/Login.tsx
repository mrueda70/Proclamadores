      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 border border-indigo-100">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Gestión de proclamadores y celebraciones
          </p>
        </div>
        ...
        <div className="space-y-4">
          <button
            ...
            className="w-full py-3 px-4 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors font-medium flex items-center justify-center gap-3"
          >
